...
// TODO
export const ROUTER_ADDRESS = '0x287c57bAD76120620245b5655cF2f2aCE451c88B'
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  [ChainId.MAINNET]: [
    [
      new Token(ChainId.MAINNET, '0x9829509cc1C745188059F06bd4c79EDa927744aD', 18, 'WIBU', 'WIBU Swap'),
      new Token(ChainId.MAINNET, '0x3656F3Db7249ee7FbF2e706D68729704E7017046', 18, 'WBNB', 'Wrapped DNY')
    ],
    [BUSD, USDT],
    [DAI, USDT]
  ]
