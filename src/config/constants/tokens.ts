...
export const mainnetTokens = {
  ...
  bnb: new Token(MAINNET, '0x3a7fD56f4C2701bcD26E566782FF1Ba49113f5b8', 18, 'BNB', 'BNB', 'https://www.binance.com/'),
  cake: new Token(
    MAINNET,
    '0x35A7B6Cc2bF890f367621ffF385d47Fb6cEF4FD6',
    18,
    'CAKE',
    'PancakeSwap Token',
  ...
  syrup: new Token(
    MAINNET,
    '0x6dfD4dD359B55ef914D0a216661151F730b47421',
    18,
    'SYRUP',
    'SyrupBar Token',
    'https://pancakeswap.finance/',
